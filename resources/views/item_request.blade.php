    ...
    <div class="pinjam-left">
        ...
        <div class="data-table-wrap">
            ...
            <div style="padding:8px 0;">
                ...
                <div class="barang-row">
                    <div class="barang-info">
                        <div class="barang-nama">{{ $pj->goodItem->name ?? '-' }}</div>
                        <div class="barang-meta">
                    ...
                    <div style="display:flex;gap:6px;">
                        ...
                        <button class="btn-sm btn-edit"
                            onclick="openEdit({{ $pj->id }}, '{{ addslashes($pj->barang->nama ?? '') }}', {{ $pj->jumlah }}, '{{ addslashes($pj->catatan ?? '') }}', {{ $pj->goodItem->stok ?? 0 }})">
        ...
        <div class="keranjang-box">
            ...
            <div id="keranjangList">
                ...
                <div class="keranjang-item" id="ki-{{ $item['barang_id'] }}">
                    ...
                    <form method="POST" action="{{ route('peminjaman.keranjang.hapus', $item['barang_id']) }}" style="display:inline;">
                        @csrf @method('DELETE')
            ...
            @if(session('keranjang') && count(session('keranjang')) > 0)
            <form method="POST" action="{{ route('peminjaman.ajukan') }}" style="margin-top:12px;">
                @csrf
...
<div class="modal-overlay" id="modalTambah">
    <div class="modal-box">
        ...
        <form method="POST" action="{{ route('peminjaman.keranjang.tambah') }}" id="formTambah">
            @csrf
...
<script>
    ...
    function openHapus(id, nama) {
        ...
        document.getElementById('formHapus').action = `/peminjaman/${id}`;
